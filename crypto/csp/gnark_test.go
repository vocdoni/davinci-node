...
func TestEmulatedCSPProofCircuit(t *testing.T) {
	...
	ffPID := processID.BigInt().ToFF(circuits.BallotProofCurve.ScalarField()).MathBigInt()
...
func TestCSPProofCircuit(t *testing.T) {
	...
	ffPID := types.BigIntConverter(processID.MathBigInt()).ToFF(circuits.BallotProofCurve.ScalarField()).MathBigInt()
	ffAddress := types.BigIntConverter(userAddress.Big()).ToFF(circuits.BallotProofCurve.ScalarField()).MathBigInt()
	ffWeight := userWeight.ToFF(circuits.BallotProofCurve.ScalarField()).MathBigInt()
