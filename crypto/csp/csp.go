// csp package provides the basic methods to create and verify certificates of
// voters eligibility of a Credential Service Providers (CSP). This package
...
// New creates a new CredentialServiceProviders (CSP) based on the given origin.
