...
=======
    ...
    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 = 14977837674310836208835173573549736769785339891456016936843752632383187160168;
    uint256 constant BETA_NEG_X_1 = 18942090130740332923755183338229907654249022735989811907299987353274646199815;
    uint256 constant BETA_NEG_Y_0 = 14319370299139041160112218609649230857543986793693447170924969220967449200273;
    uint256 constant BETA_NEG_Y_1 = 819079897723769236706726057903203869868640641804085217440511048912233320222;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 = 14386657906070012506138848812498974573967427467126482056372301702334239843798;
    uint256 constant GAMMA_NEG_X_1 = 4558313514082912884231504687846380441189672700601581324851292483115781389579;
    uint256 constant GAMMA_NEG_Y_0 = 12579393661070296987152441583308010111807938513412360090095122846514643344915;
    uint256 constant GAMMA_NEG_Y_1 = 20590341522869965920883750986936476651933701399469265858514438872932817529174;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 = 154602921992781034714467116884649054952939524182945063285312879956526356920;
    uint256 constant DELTA_NEG_X_1 = 7741233977927324599332181319184838319582021033125123003667850678117823824918;
    uint256 constant DELTA_NEG_Y_0 = 16838751859510452055903842643155913101786807259090874282228725325564046939775;
    uint256 constant DELTA_NEG_Y_1 = 6357029002738369509561591082753197988764624377167611526621087643645674285538;
    // Pedersen G point in G2 in powers of i
    uint256 constant PEDERSEN_G_X_0 = 18310386809808281239405342331021600502622460550857366775358643958002154481387;
    uint256 constant PEDERSEN_G_X_1 = 7773023292959385161767247413371881573194853173467481673726841053384237247139;
    uint256 constant PEDERSEN_G_Y_0 = 20750673260960129735440430323505037776557240691477675177072427059284026138879;
    uint256 constant PEDERSEN_G_Y_1 = 14075568686077656014425043758490810735352372689578834458602554647165428593203;

    // Pedersen GSigmaNeg point in G2 in powers of i
    uint256 constant PEDERSEN_GSIGMANEG_X_0 = 18938386160627673248299549975639001746413695358666225578166931577775803060801;
    uint256 constant PEDERSEN_GSIGMANEG_X_1 = 2385817471185723441404783376606050455308592492042285840791287756958362105148;
    uint256 constant PEDERSEN_GSIGMANEG_Y_0 = 4864468874729619065032736413301324669884047731381841983926684267399806028943;
    uint256 constant PEDERSEN_GSIGMANEG_Y_1 = 5596494896094836781807672966088706480321410977363360828021801636571829868861;
