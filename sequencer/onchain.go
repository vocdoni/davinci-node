...
func (s *Sequencer) processTransitionOnChain() {
	...
	s.pids.ForEach(func(processID types.ProcessID, _ time.Time) bool {
		...
		if err := s.pushTransitionToContract(processID, solidityCommitmentProof, batch.Inputs, batch.BlobSidecar); err != nil {
...
func (s *Sequencer) recoverPendingBatch(pid types.ProcessID) error {
...
func (s *Sequencer) pushStateTransitionCallback(pid types.ProcessID) func(err error) {
