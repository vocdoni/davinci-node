...
func (c *Contracts) sendProcessTransition(processID types.ProcessID, proof, inputs []byte, blobsSidecar *gethtypes.BlobTxSidecar) (types.HexBytes, *common.Hash, error) {
