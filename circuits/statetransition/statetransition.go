...
func (circuit StateTransitionCircuit) VerifyAggregatorProof(api frontend.API, isRealVote []frontend.Variable) {
	...
	// groth16.WithSubgroupCheck() is omitted to save constraints, since aggregator proofs
	// are generated by the local sequencer pipeline rather than accepted from external submitters.
