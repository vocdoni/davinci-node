...
// CalculateBallotIndex replicates types.CalculateBallotIndex inside the circuit.
// It takes the low 16 bits of the address, applies the census index offset,
...
func CalculateBallotIndex(api frontend.API, address, censusIndex frontend.Variable) frontend.Variable {
	...
	addressLE := api.ToBinary(address, params.AddressBitLen)
