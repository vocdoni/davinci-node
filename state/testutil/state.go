...
func NewVoteForTest(publicKey ecc.Point, censusIndex uint64, value int) *state.Vote {
	...
	return &state.Vote{
		Address:           testutil.DeterministicAddress(censusIndex).Big(),
		BallotIndex:       types.CalculateBallotIndex(censusIndex),
