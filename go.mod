...
require (
	...
	github.com/vocdoni/census3-bigquery v0.0.0-20251127120211-7a39c5dc9fe9
	github.com/vocdoni/davinci-contracts v0.0.28-1
	github.com/vocdoni/gnark-crypto-primitives v0.0.2-0.20251203172124-5c1b39924159
