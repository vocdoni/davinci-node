...
replace github.com/consensys/gnark => github.com/vocdoni/gnark v0.0.0-20260424131830-d1d3e6b7e13d
...
require (
	...
	github.com/vocdoni/davinci-contracts v0.0.47-0.20260506094505-a1e1fe8e8006
