...
replace github.com/consensys/gnark => github.com/vocdoni/gnark-no-assert v0.0.0-20250723072250-450d563bbc0b
...
require (
	...
	github.com/vocdoni/davinci-contracts v0.0.0-20250709172536-328a506c66c4
